...
- [ADR 018 — Recipe Collections](ADRs/018-recipe-collections.md) — named, ordered sets of recipes backed by the existing `RecipeGroup` mechanism under a new `COLLECTION` type, with case-insensitive unique names (extends ADR 008)
